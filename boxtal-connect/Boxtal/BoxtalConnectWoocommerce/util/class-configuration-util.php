...
class Configuration_Util {
	 ...
	 * @var string
	 */
	private static $shop_uuid_config = 'BW_SHOP_UUID';
	...
	public static function get_deleted_orders() {
		return json_decode( get_option( 'BW_DELETED_ORDERS', '[]' ), true );
	}
	...
	public static function set_deleted_orders( $order_ids ) {
		return update_option( 'BW_DELETED_ORDERS', wp_json_encode( $order_ids ) );
	}
