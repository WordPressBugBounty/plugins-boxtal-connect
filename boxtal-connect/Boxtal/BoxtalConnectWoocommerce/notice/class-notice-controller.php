...
class Notice_Controller {
	...
	public function __construct( $plugin ) {
		...
		$this->ajax_nonce     = wp_create_nonce( 'boxtal_woocommerce_notice' );
	}
	...
	public function init_notices() {
		...
		if ( 'boxtal-connect-settings' === $plugin_page ) {
	...
	public function notice_scripts() {
		...
		wp_enqueue_script( 'bw_notices', $this->plugin_url . 'Boxtal/BoxtalConnectWoocommerce/assets/js/notices.min.js', array( 'bw_polyfills' ), $this->plugin_version, false );

		$data = array( 'noticeAjaxNonce' => $this->ajax_nonce );
		Frontend_Util::inject_inline_data( 'bw_notices', 'bwData', $data );
	}
	...
	public function hide_notice_callback() {
		check_ajax_referer( 'boxtal_woocommerce_notice', 'security' );
