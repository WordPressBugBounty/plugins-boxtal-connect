...
class Parcel_Point_Block_Integration implements IntegrationInterface {
	...
	public function initialize() {
		...
		wp_enqueue_script( 'bw_polyfills', $assets_path . '/js/polyfills.min.js', array(), '2.0.2', false );
		wp_enqueue_script( 'bw_maplibre_gl', $assets_path . '/js/maplibre-gl.js', array(), '2.0.2', false );
		wp_enqueue_script( 'bw_shipping', $assets_path . '/js/parcel-point.min.js', array( 'jquery-core', 'wp-hooks', 'wp-i18n' ), '2.0.2', false );
		wp_enqueue_style( 'bw_maplibre_gl', $assets_path . '/css/maplibre-gl.min.css', array(), '2.0.2' );
		wp_enqueue_style( 'bw_parcel_point', $assets_path . '/css/parcel-point.css', array(), '2.0.2' );
